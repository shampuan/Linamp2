...
This is a lightweight music player application developed for Debian-based systems, built using Qt and MPV. It is the successor to "Linamp" and has been rewritten from scratch. The original Linamp project can be found here: https://github.com/shampuan/LinAMP

The project will now continue to be developed based on this version. New features and bug fixes will be implemented within this version.
